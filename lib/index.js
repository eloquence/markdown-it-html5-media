...
// May be overwritten through options.messages
let messages = {
  en: {
...
// May be overwritten through options.translateFn
...
function guessMediaType(url) {
  ...
  if (validAudioExtensions.indexOf(extension) != -1)
    return 'audio';
  else if (validVideoExtensions.indexOf(extension) != -1)
    return 'video';
  else
    return 'image';
}
